...
function ovation_blog_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('ovation_blog_site_title_fontsize',array(
		'default'=> 25,
		'transport' => 'refresh',
		'sanitize_callback' => 'ovation_blog_sanitize_integer'
	));
	$wp_customize->add_control(new Ovation_Blog_Slider_Custom_Control( $wp_customize, 'ovation_blog_site_title_fontsize',array(
		'label' => esc_html__( 'Site Title font size','ovation-blog' ),
		'section'=> 'title_tagline',
		'settings'=>'ovation_blog_site_title_fontsize',
		'input_attrs' => array(
			'reset'			   => 25,
            'step'             => 1,
			'min'              => 0,
	...
	$wp_customize->add_setting('ovation_blog_site_tagline_fontsize',array(
		'default'=> 15,
		'transport' => 'refresh',
		'sanitize_callback' => 'ovation_blog_sanitize_integer'
	));
	$wp_customize->add_control(new Ovation_Blog_Slider_Custom_Control( $wp_customize, 'ovation_blog_site_tagline_fontsize',array(
		'label' => esc_html__( 'Site Tagline font size','ovation-blog' ),
		'section'=> 'title_tagline',
		'settings'=>'ovation_blog_site_tagline_fontsize',
		'input_attrs' => array(
			'reset'			   => 15,
            'step'             => 1,
			'min'              => 0,
	...
	$wp_customize->add_setting( 'ovation_blog_reset_colors', array(
	    'default'           => '',
	    'sanitize_callback' => 'sanitize_text_field',
	    'transport'         => 'postMessage', 
	) );

	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ovation_blog_reset_colors', array(
	    'label'       => esc_html__( 'Reset Colors', 'ovation-blog' ),
	    'section'     => 'colors',
	    'settings'    => 'ovation_blog_reset_colors',
	    'type'        => 'button',
	    'input_attrs' => array(
	...
	$wp_customize->add_setting('ovation_blog_menu_fontsize',array(
		'default'=> 14,
		'transport' => 'refresh',
		'sanitize_callback' => 'ovation_blog_sanitize_integer'
	));
	$wp_customize->add_control(new Ovation_Blog_Slider_Custom_Control( $wp_customize, 'ovation_blog_menu_fontsize',array(
		'label' => esc_html__( 'menu font size','ovation-blog' ),
		'section'=> 'ovation_blog_theme_settings',
		'settings'=>'ovation_blog_menu_fontsize',
		'input_attrs' => array(
			'reset'			   => 14,
            'step'             => 1,
			'min'              => 0,
	...
	$wp_customize->add_section('ovation_blog_blog_meta',array(
        'title' => __('Blog Meta', 'ovation-blog'), 
        'panel' => 'ovation_blog_post_panel',       
    ) );

    $wp_customize->add_setting( 'ovation_blog_section_blog_meta_heading', array(
		'default'           => '',
		'transport'         => 'refresh',
		'sanitize_callback' => 'sanitize_text_field',
	) );
	$wp_customize->add_control( new Ovation_Blog_Customizer_Customcontrol_Section_Heading( $wp_customize, 'ovation_blog_section_blog_meta_heading', array(
		'label'       => esc_html__( 'Blog Meta Settings', 'ovation-blog' ),
		'section'     => 'ovation_blog_blog_meta',
		'settings'    => 'ovation_blog_section_blog_meta_heading',
	) ) );
	...
	$wp_customize->add_setting('ovation_blog_date_type',array(
        'default' => 'published',
        'sanitize_callback' => 'ovation_blog_sanitize_choices'
	));
	$wp_customize->add_control('ovation_blog_date_type',array(
		'type' => 'radio',
		'label'     => __('Date Format', 'ovation-blog'),
		'section' => 'ovation_blog_blog_meta',
		'type' => 'select',
		'choices' => array(
			'published' => __('published date','ovation-blog'),
            'modified' => __('modified date','ovation-blog'),
		),
	) );
	...
	$wp_customize->add_section('ovation_blog_blog_pagination',array(
        'title' => __('Pagination', 'ovation-blog'), 
        'panel' => 'ovation_blog_post_panel',       
    ) );

	$wp_customize->add_setting('ovation_blog_pagination_type',array(
        'default' => 'numbered',
        'sanitize_callback' => 'ovation_blog_sanitize_choices'
	));
	$wp_customize->add_control('ovation_blog_pagination_type',array(
		'type' => 'radio',
	'label'     => __('Blog Pagination', 'ovation-blog'),
		'section' => 'ovation_blog_blog_pagination',
		'type' => 'select',
		'choices' => array(
			'default' => __('Previous/Next','ovation-blog'),
            'numbered' => __('Numbered','ovation-blog'),
		),
	) );

	$wp_customize->add_setting('ovation_blog_single_post_pagination_type',array(
        'default' => 'default',
        'sanitize_callback' => 'ovation_blog_sanitize_choices'
	));
	$wp_customize->add_control('ovation_blog_single_post_pagination_type',array(
		'type' => 'radio',
		'label'     => __('Post Pagination', 'ovation-blog'),
		'section' => 'ovation_blog_blog_pagination',
		'type' => 'select',
		'choices' => array(
			'default' => __('Previous/Next','ovation-blog'),
            'post-name' => __('Post Title','ovation-blog'),
		),
	) );
	...
	$wp_customize->add_setting('ovation_blog_menu_icon',array(
		'default'	=> 'fas fa-bars',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new Ovation_Blog_Fontawesome_Icon_Chooser(
        $wp_customize,'ovation_blog_menu_icon',array(
		'label'	=> __('Menu Icon','ovation-blog'),
		'transport' => 'refresh',
		'section'	=> 'ovation_blog_mobile_options',
		'setting'	=> 'ovation_blog_menu_icon',
		'type'		=> 'icon'
	))); 
	$wp_customize->add_setting(
    ...
    public function render_content(){?>
        <label style="overflow: hidden; zoom: 1;">
	        <div class="col-md upsell-btn">
                <a href="<?php echo esc_url( OVATION_BLOG_BUY_PRO ); ?>" target="blank" class="btn btn-success btn"><?php esc_html_e('UPGRADE BLOG PREMIUM','ovation-blog');?> </a>
	        </div>
            <div class="col-md">
                <img class="ovation_blog_img_responsive " src="<?php echo esc_url(get_template_directory_uri()); ?>/screenshot.png">
            </div>
	        <div class="col-md">
	            <h3 style="margin-top:10px; margin-left: 20px; font-size:12px; text-decoration:underline; color:#333;"><?php esc_html_e('BLOG PREMIUM - Features', 'ovation-blog'); ?></h3>
		 ...
		 <div class="col-md upsell-btn upsell-btn-bottom">
	            <a href="<?php echo esc_url( OVATION_BLOG_BUNDLE_LINK ); ?>" target="blank" class="btn btn-success btn"><?php esc_html_e('WP Theme Bundle (120+ Themes)','ovation-blog');?> </a>
		    </div>
        </label>
    <?php } }
endif;
