...
$ovation_blog_custom_style .='nav#top_gb_menu ul li a{';
	...
	$ovation_blog_custom_style .='text-transform: capitalize ;';
...
$ovation_blog_custom_style .='nav#top_gb_menu ul li a{';
	...
	$ovation_blog_custom_style .='text-transform: uppercase ; ';
...
$ovation_blog_custom_style .='nav#top_gb_menu ul li a{';
	...
	$ovation_blog_custom_style .='text-transform: lowercase ; ';
...
$color_fade = get_theme_mod('ovation_blog_primary_fade', '#cddfcf');
$color_footer_bg = get_theme_mod('ovation_blog_footer_bg', '#323232');
$color_post_bg = get_theme_mod('ovation_blog_post_bg', '#ffffff');
$slider_overlay = get_theme_mod( 'ovation_blog_slider_overlay','#000000');
...
$ovation_blog_custom_style .= ":root {";
    ...
    $ovation_blog_custom_style .= "--slider-overlay: {$slider_overlay};";
$ovation_blog_custom_style .= "}";
...
$ovation_blog_slider_heading_color = get_theme_mod( 'ovation_blog_slider_heading_color','#ffffff');
$ovation_blog_custom_style .='#slider .carousel-caption h2 a{';
$ovation_blog_custom_style .='color: '.esc_attr($ovation_blog_slider_heading_color).';';
$ovation_blog_custom_style .='}';

//-------------------title-font-size----//  
$ovation_blog_site_title_fontsize = get_theme_mod('ovation_blog_site_title_fontsize','25');

if($ovation_blog_site_title_fontsize != false){

$ovation_blog_custom_style .='.logo h1,.site-title,.site-title a,.logo h1 a{';

    $ovation_blog_custom_style .='font-size: '.esc_html($ovation_blog_site_title_fontsize).'px;';

$ovation_blog_custom_style .='}';
}

//-------------------tagline-font-size----//  
$ovation_blog_site_tagline_fontsize = get_theme_mod('ovation_blog_site_tagline_fontsize','15');

if($ovation_blog_site_tagline_fontsize != false){

$ovation_blog_custom_style .='p.site-description{';

    $ovation_blog_custom_style .='font-size: '.esc_html($ovation_blog_site_tagline_fontsize).'px;';

$ovation_blog_custom_style .='}';
}

//-------------------menu-font-size----//  
$ovation_blog_menu_fontsize = get_theme_mod('ovation_blog_menu_fontsize','14');

if($ovation_blog_menu_fontsize != false){

$ovation_blog_custom_style .='.gb_nav_menu li a{';

    $ovation_blog_custom_style .='font-size: '.esc_html($ovation_blog_menu_fontsize).'px;';
