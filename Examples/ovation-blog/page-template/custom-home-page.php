    ...
    <div class="col-lg-6 col-md-6 media-post-pad">
      <?php if( get_theme_mod('ovation_blog_post_category_setting') != ''){ ?>
        <div id="our-post">
          <div class="row">
            <?php
            $ovation_blog_catData1=  get_theme_mod('ovation_blog_post_category_setting');
            $ovation_blog_post_category_order = get_theme_mod('ovation_blog_post_category_order_type','ascending');
            if($ovation_blog_catData1){
              $ovation_blog_args = array( 
            ...
            if ($ovation_blog_post_category_order == 'descending') {
              $ovation_blog_args['order'] = 'DESC';
            } else if ($ovation_blog_post_category_order == 'a-to-z') {
              $ovation_blog_args['orderby'] = 'title';
              $ovation_blog_args['order'] = 'ASC';
            } else if ($ovation_blog_post_category_order == 'z-to-a') {
              $ovation_blog_args['orderby'] = 'title';
              $ovation_blog_args['order'] = 'DESC';
            }
            $ovation_blog_page_query = new WP_Query($ovation_blog_args);?>
    ...
    <?php if( get_theme_mod('ovation_blog_top_category_text') != '' || get_theme_mod('ovation_blog_top_category_heading') != ''|| get_theme_mod('ovation_blog_top_category_setting') != ''){ ?>
      <section id="top-cat">
        <div class="container-fluid">
          ...
          <div class="row">
            <?php
            $ovation_blog_catData1=  get_theme_mod('ovation_blog_top_category_setting');
            $ovation_blog_top_category = get_theme_mod('ovation_blog_top_category_type','ascending');
            if($ovation_blog_catData1){
              $ovation_blog_args = array( 
            ...
            // Adjust ordering based on user selection
            if ($ovation_blog_top_category == 'descending') {
              $ovation_blog_args['order'] = 'DESC';
            } else if ($ovation_blog_top_category == 'a-to-z') {
              $ovation_blog_args['orderby'] = 'title';
              $ovation_blog_args['order'] = 'ASC';
            } else if ($ovation_blog_top_category == 'z-to-a') {
              $ovation_blog_args['orderby'] = 'title';
              $ovation_blog_args['order'] = 'DESC';
            }
            $ovation_blog_page_query = new WP_Query($ovation_blog_args);?>
